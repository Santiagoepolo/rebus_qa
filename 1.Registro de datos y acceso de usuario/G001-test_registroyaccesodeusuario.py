...
class TestRegistroyaccesodeusuario():
  ...
  def test_registroyaccesodeusuario(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".result").text == "Your registration completed"
    self.driver.find_element(By.LINK_TEXT, "Log out").click()
    assert self.driver.find_element(By.LINK_TEXT, "Register").text == "Register"
    self.driver.close()
